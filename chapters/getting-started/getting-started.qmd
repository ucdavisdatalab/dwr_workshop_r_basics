...
This chapter is an introduction the R programming language and programming in
general. We explain how to write, run, and get help with R code. The examples,
which are meant for following along, demonstrate several important programming
concepts. We also introduce RStudio, an editor for R code, and explain how to
how to install packages, R code developed by the community for anyone to use.
...
* Over 23,000 community-developed **packages**: reusable bundles of code, often
  accompanied by documentation, examples, or datasets
...
constants (such as `?pi`), datasets (such as `?penguins`), and operators. To
...
include documentation, and can also contain examples, vignettes, and datasets.
